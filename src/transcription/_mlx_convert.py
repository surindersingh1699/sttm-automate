...
# VENDORED from https://github.com/ml-explore/mlx-examples/blob/main/whisper/convert.py
# mlx-whisper on PyPI doesn't ship this as a package module; a vendored copy
# gives programmatic HF→MLX conversion at first load. Only convert() and
# quantize() are used; the argparse CLI main is dead code when imported.
